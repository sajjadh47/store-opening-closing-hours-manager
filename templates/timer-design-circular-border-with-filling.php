<?php
/**
 * Template for timer design (circular border with filling).
 *
 * This file is used to markup the circular border with filling timer design.
 *
 * This template can be overridden by copying it to yourtheme/sochm/timer-design-circular-border-with-filling.php.
 *
 * @since         2.0.0
